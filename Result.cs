...
namespace Regla
{
    ...
    /**
     * Partial specialization of template, leaving out OUTPUT
     */
    public class RuleResultAttribute<COMPONENT> : RuleResultAttributes<COMPONENT, object>
        where COMPONENT : class
    {
        public RuleResultAttribute(Rule<COMPONENT> rule, bool returnValue, Exception exception)
            : base(rule, returnValue, exception)
        { }
    }
}
